 ...
 * @author VC6AF18
 */
@ManagedBean(name = "py_detalleAdopcionBean")
@SessionScoped
public class PY_detalleAdopcionBean implements Serializable{
    private static final long serialVersionUID=1L;
    private static final Logger logger = Logger.getLogger(PY_detalleAdopcionBean.class);
    
    private final PY_Adopcion_v2 py_adopcion;    
    ...
    private List<PY_Adopcion_v2> lista_adopcion;
    ...
    public PY_detalleAdopcionBean() {   
        super();      
        py_adopcion = new PY_Adopcion_v2();
    }
    ...
    public void init(){
        ...
        lista_adopcion = py_catalogosService.getPy_catalogos().lista_adopcionFiltro(idSeleccionadoAnio, idSeleccionadoMes, idSeleccionadoQuincena, idSeleccionadoRegion, "1,2");
        total_columnas_rs();
    }
    ...
    public void total_columnas_rs(){
        total_RS=0;
        for(PY_Adopcion_v2 total : lista_adopcion) {
            total_RS += total.getTotal_rfc();
        }
    }
    ...
    public List<PY_Adopcion_v2> getLista_adopcion() {
        return lista_adopcion;
    }

    public void setLista_adopcion(List<PY_Adopcion_v2> lista_adopcion) {
        this.lista_adopcion = lista_adopcion;
    }
