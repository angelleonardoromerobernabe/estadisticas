 ...
 * @author VC6AF18
 */
@ManagedBean(name = "py_adopcionBean")
@SessionScoped
public class PY_adopcionBean implements Serializable{
    private static final long serialVersionUID=1L;
    private static final Logger logger = Logger.getLogger(PY_adopcionBean.class);
    ...
    public void init(){
        ...
        lista_adopcion = py_catalogosService.getPy_catalogos().lista_adopcionFiltro(idSeleccionadoAnio, idSeleccionadoMes, idSeleccionadoQuincena, idSeleccionadoRegion, "1");
        total_columnas_rs();
    }
